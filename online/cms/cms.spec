...
struct main_metadata_t {
	...
	bit<32> local_metadata_unique_count
...
regarray unique_flows_0 size 0x1 initval 0
...
apply {
	...
	jmpeq LABEL_TRUE_0 m.local_metadata_count_0 0x0
	jmpeq LABEL_TRUE_0 m.local_metadata_count_1 0x0
	jmpeq LABEL_TRUE_0 m.local_metadata_count_2 0x0
	jmpeq LABEL_TRUE_0 m.local_metadata_count_3 0x0
	jmp LABEL_END_0
	LABEL_TRUE_0 :	regrd m.local_metadata_unique_count unique_flows_0 0x0
	mov m.MainControlT_tmp_19 m.local_metadata_unique_count
	add m.MainControlT_tmp_19 0x1
	and m.MainControlT_tmp_19 0xFFFFF
	regwr unique_flows_0 0x0 m.MainControlT_tmp_19
	LABEL_END_0 :	mov m.local_metadata_dif 0xFFFFF
	...
	jmpgt LABEL_TRUE_1 m.MainControlT_tmp 0x0
	jmp LABEL_END_1
	LABEL_TRUE_1 :	mov m.local_metadata_minimum m.local_metadata_count_0
	...
	jmpgt LABEL_TRUE_2 m.MainControlT_tmp_0 0x0
	jmp LABEL_END_2
	LABEL_TRUE_2 :	mov m.local_metadata_minimum m.local_metadata_count_1
	...
	jmpgt LABEL_TRUE_3 m.MainControlT_tmp_1 0x0
	jmp LABEL_END_3
	LABEL_TRUE_3 :	mov m.local_metadata_minimum m.local_metadata_count_2
	LABEL_END_3 :	mov m.local_metadata_dif m.local_metadata_minimum
	...
	jmpgt LABEL_TRUE_4 m.MainControlT_tmp_2 0x0
	jmp LABEL_END_4
	LABEL_TRUE_4 :	mov m.local_metadata_minimum m.local_metadata_count_3
	LABEL_END_4 :	jmpgt LABEL_TRUE_5 m.local_metadata_minimum 0x186A0
	mov m.MainControlT_tmp_20 m.local_metadata_count_0
	add m.MainControlT_tmp_20 0x1
	and m.MainControlT_tmp_20 0xFFFFF
	regwr ht0_0 m.local_metadata_flow_id0 m.MainControlT_tmp_20
	mov m.MainControlT_tmp_21 m.local_metadata_count_1
	add m.MainControlT_tmp_21 0x1
	and m.MainControlT_tmp_21 0xFFFFF
	regwr ht1_0 m.local_metadata_flow_id1 m.MainControlT_tmp_21
	mov m.MainControlT_tmp_22 m.local_metadata_count_2
	add m.MainControlT_tmp_22 0x1
	and m.MainControlT_tmp_22 0xFFFFF
	regwr ht2_0 m.local_metadata_flow_id2 m.MainControlT_tmp_22
	mov m.MainControlT_tmp_23 m.local_metadata_count_3
	add m.MainControlT_tmp_23 0x1
	and m.MainControlT_tmp_23 0xFFFFF
	regwr ht3_0 m.local_metadata_flow_id3 m.MainControlT_tmp_23
	...
	jmpneq LABEL_FALSE_6 m.pna_main_input_metadata_input_port 0x0
	mov m.pna_main_output_metadata_output_port 0x0
	jmp LABEL_END
	LABEL_FALSE_6 :	jmpneq LABEL_END m.pna_main_input_metadata_input_port 0x1
